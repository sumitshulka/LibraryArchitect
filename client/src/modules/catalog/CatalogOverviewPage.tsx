      ...
      <div className="w-full">
        <div className="w-full">
          ...
          <div className="mt-5 flex flex-col justify-between gap-3 border-t pt-4 text-xs text-muted-foreground sm:flex-row">
            ...
            <Link href="/settings" className="flex items-center gap-1.5 font-medium text-primary hover:underline" data-testid="link-catalog-settings">Catalog settings <Settings2 className="h-3.5 w-3.5" /></Link>
          </div>
        </div>
